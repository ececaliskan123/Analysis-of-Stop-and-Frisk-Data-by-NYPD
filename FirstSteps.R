...
covariates <- c("year","datestop","timestop","pct","sex","race","ht_feet", "ht_inch", "weight", "age", 
                ...
                "crimsusp", "pistol", "riflshot", "asltweap", "knifcuti" , "machgun" ,"othrweap")  #crimsusp is needed to construct dependent variable
...
df[,c("pistol", "riflshot", "asltweap", "knifcuti" , "machgun" ,"othrweap")] <-NULL
